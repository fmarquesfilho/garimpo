...
- `categorias[]` (plural, filtro OR) — ver [ADR 0006](/decisoes/0006-categorias-plural)
...
Ver [ADR 0007](/decisoes/0007-persistencia-favoritos).
...
Ver [ADR 0008](/decisoes/0008-alertas-desabilitados).
