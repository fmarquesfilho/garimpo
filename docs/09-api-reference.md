...
| Get | `/api/alertas/eficacia` | AnalyzerProxyEndpoints.cs |
| Get | `/api/buscas/{id}/job` | JobStatusEndpoints.cs |
...
| Get | `/api/oportunidades/agora` | AnalyzerProxyEndpoints.cs |
...
| GET | `/conversoes` | |
| POST | `/detect-coupons` | |
| GET | `/alertas/eficacia` | |
| GET | `/estatisticas` | |
| GET | `/evolucao` | |
| GET | `/novidades` | |
| GET | `/oportunidades/agora` | |
| GET | `/quedas` | |
| GET | `/conversoes/resumo` | |
| GET | `/coletas/saude` | |
