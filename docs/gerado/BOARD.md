...
| | T-0046 Validar todos os 11 fluxos end-to-end em produção (M) | | | T-0010 Proto definitions + shopee-collector gRPC server (M) |
| | T-0048 Limpeza final: código morto, warnings, deps desatualizadas (S) | | | T-0011 Publisher gRPC server (extract publish package) (M) |
| | T-0049 Reconciliação: sincronizar buscas existentes no PG com Scheduler (S) | | | T-0012 Scheduler gRPC server (serviço Go separado) (M) |
| | T-0050 Testar envio real: Telegram + WhatsApp (Publisher end-to-end) (S) | | | T-0013 C# Web App — auth middleware + health + CI (M) |
| | T-0051 Documentação final: consolidar estado pós-migração (S) | | | T-0014 PostgreSQL schema + EF Core migrations (dados transacionais) (M) |
| | T-0052 OpenAPI spec integrada: Swagger com todas as APIs (C# + Go gRPC) (M) | | | T-0015 Multi-tenant em C# (EF Core + PostgreSQL) (G) |
| | T-0053 Avaliar alternativas ao GitHub Actions (CI/CD + hosting de git) (S) | | | T-0016 Curadoria controller + scoring port em C# (G) |
| | T-0055 Autocomplete no input de busca: parser de tokens com prefixos (@, #, !) (M) | | | T-0017 Routing split (Cloudflare Worker v1→v2) (P) |
