...
|---|---|---|
| `ADMIN_EMAILS` | `internal/auth/roles.go` | 12 |
| `ALERTAS_APENAS_QUEDAS` | `internal/alerts/alerts.go` | 44 |
| `ALERTAS_TELEGRAM_CHAT_ID` | `internal/alerts/alerts.go` | 55 |
| `ALERTAS_TELEGRAM_TOKEN` | `internal/alerts/alerts.go` | 48 |
| `ALERTAS_THRESHOLD` | `internal/alerts/alerts.go` | 39 |
