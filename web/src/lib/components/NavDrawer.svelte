	...
	>
		...
		<div class="flex-1 overflow-y-auto px-5 py-3 [-webkit-overflow-scrolling:touch]">
			<div class="flex flex-col gap-0.5 border-b border-border py-3 last:border-b-0">
				<span class="mb-2 text-xs font-bold uppercase tracking-wide text-muted-foreground opacity-70">Principal</span>
				<a
					href="/"
			...
			<div class="flex flex-col gap-0.5 border-b border-border py-3 last:border-b-0">
				<span class="mb-2 text-xs font-bold uppercase tracking-wide text-muted-foreground opacity-70">Publicar</span>
				<a
					href="/publicar"
					class="block rounded-sm px-3 py-3 font-semibold text-muted-foreground no-underline hover:bg-muted hover:text-foreground"
					class:!bg-accent={$page.url.pathname === '/publicar'}
			...
			<div class="flex flex-col gap-0.5 border-b border-border py-3 last:border-b-0">
				...
				<a
					href="/estatisticas"
					class="block rounded-sm px-3 py-3 font-semibold text-muted-foreground no-underline hover:bg-muted hover:text-foreground"
					class:!bg-accent={$page.url.pathname === '/estatisticas'}
					class:!text-foreground={$page.url.pathname === '/estatisticas'}>📊 Estatísticas</a
				>
				<a
					href="/publicacoes"
					class="block rounded-sm px-3 py-3 font-semibold text-muted-foreground no-underline hover:bg-muted hover:text-foreground"
					class:!bg-accent={$page.url.pathname === '/publicacoes'}
				...
				{#if isAdmin}
					<a
						href="/coletas"
						class="block rounded-sm px-3 py-3 font-semibold text-muted-foreground no-underline hover:bg-muted hover:text-foreground"
						class:!bg-accent={$page.url.pathname === '/coletas'}
						class:!text-foreground={$page.url.pathname === '/coletas'}>⏱ Coletas</a
					>
					<a
						href="/admin"
						class="block rounded-sm px-3 py-3 font-semibold text-muted-foreground no-underline hover:bg-muted hover:text-foreground"
						class:!bg-accent={$page.url.pathname === '/admin'}
			...
			<div class="flex flex-col gap-0.5 border-b border-border py-3 last:border-b-0">
				...
				<a
					href="/canais"
					class="block rounded-sm px-3 py-3 font-semibold text-muted-foreground no-underline hover:bg-muted hover:text-foreground"
					class:!bg-accent={$page.url.pathname === '/canais'}
					class:!text-foreground={$page.url.pathname === '/canais'}>📡 Destinos</a
				>
				<a
					href="/configurar"
					class="block rounded-sm px-3 py-3 font-semibold text-muted-foreground no-underline hover:bg-muted hover:text-foreground"
					class:!bg-accent={$page.url.pathname === '/configurar'}
		...
		<div class="flex shrink-0 items-center justify-between border-t border-border px-5 py-4">
			<span class="max-w-[150px] truncate text-xs text-muted-foreground">{usuario.nome ?? usuario.email}</span>
