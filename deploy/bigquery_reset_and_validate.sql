...
-- Projeto: garimpo-500114 | Dataset: garimpei
-- =============================================================================
...
TRUNCATE TABLE `garimpo-500114.garimpei.eventos`;

-- Buscas: limpar — agora gerenciadas pelo PostgreSQL (C# API)
TRUNCATE TABLE `garimpo-500114.garimpei.buscas`;

-- Publicações: limpar — agora gerenciadas pelo PostgreSQL
TRUNCATE TABLE `garimpo-500114.garimpei.publicacoes`;

-- Destinos: limpar — agora gerenciados pelo PostgreSQL
TRUNCATE TABLE `garimpo-500114.garimpei.destinos`;

-- Templates: limpar — agora gerenciados pelo PostgreSQL
TRUNCATE TABLE `garimpo-500114.garimpei.templates`;

-- Favoritos: limpar — agora gerenciados pelo PostgreSQL
TRUNCATE TABLE `garimpo-500114.garimpei.favoritos`;

-- Conversões: MANTER (dados reais da Shopee, se houver)
-- TRUNCATE TABLE `garimpo-500114.garimpei.conversoes`;
...
-- FROM `garimpo-500114.garimpei.snapshots`
...
-- FROM `garimpo-500114.garimpei.snapshots` a
-- JOIN `garimpo-500114.garimpei.snapshots` b
